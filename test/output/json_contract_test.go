...
func TestWriteJSONEnvelopeContractForOnlineInvoiceResult(t *testing.T) {
	...
	breadcrumbs := []output.Breadcrumb{{Action: "show", Cmd: "xero invoices online-url --invoice-id 220ddca8-3144-4085-9a88-2d72c5133734 --json"}}

	if err := output.WriteJSON(&buffer, result, "online invoice URL available", breadcrumbs, false); err != nil {
		t.Fatalf("write json: %v", err)
	}

	expected := "{\n  \"ok\": true,\n  \"data\": {\n    \"invoiceId\": \"220ddca8-3144-4085-9a88-2d72c5133734\",\n    \"onlineInvoiceUrl\": \"https://in.xero.com/abc\",\n    \"available\": true\n  },\n  \"summary\": \"online invoice URL available\",\n  \"breadcrumbs\": [\n    {\n      \"action\": \"show\",\n      \"cmd\": \"xero invoices online-url --invoice-id 220ddca8-3144-4085-9a88-2d72c5133734 --json\"\n    }\n  ]\n}\n"
	if buffer.String() != expected {
		t.Fatalf("unexpected envelope:\n%s", buffer.String())
	}
}
...
func TestWriteJSONEnvelopeContractForInvoicePDFResult(t *testing.T) {
	...
	breadcrumbs := []output.Breadcrumb{{Action: "show", Cmd: "xero invoices pdf --invoice-id 220ddca8-3144-4085-9a88-2d72c5133734 --output invoice.pdf --json"}}

	if err := output.WriteJSON(&buffer, result, "invoice PDF saved", breadcrumbs, false); err != nil {
		t.Fatalf("write json: %v", err)
	}

	expected := "{\n  \"ok\": true,\n  \"data\": {\n    \"invoiceId\": \"220ddca8-3144-4085-9a88-2d72c5133734\",\n    \"contentType\": \"application/pdf\",\n    \"bytes\": 48213,\n    \"output\": \"file\",\n    \"savedTo\": \"invoice.pdf\",\n    \"streamed\": false\n  },\n  \"summary\": \"invoice PDF saved\",\n  \"breadcrumbs\": [\n    {\n      \"action\": \"show\",\n      \"cmd\": \"xero invoices pdf --invoice-id 220ddca8-3144-4085-9a88-2d72c5133734 --output invoice.pdf --json\"\n    }\n  ]\n}\n"
	if buffer.String() != expected {
		t.Fatalf("unexpected envelope:\n%s", buffer.String())
	}
}
